...
const navigation = [
  ...
  { href: '/dashboard/mitarbeiter', label: 'Mitarbeiter', icon: UserRoundCheck, active: true },
  ...
  { href: '/dashboard/arbeitszeiten', label: 'Arbeitszeiten', icon: Clock3, active: true },
  { href: '/dashboard/urlaub-krankheit', label: 'Urlaub & Krankheit', icon: CalendarDays },
  { href: '/dashboard/reklamationen', label: 'Reklamationen', icon: Bell, active: true },
  { href: '/dashboard/qualitaetskontrolle', label: 'Qualitaetskontrolle', icon: ClipboardCheck, active: true },
