...
export default async function DashboardPage() {
  ...
  const metrics = [
    ...
    { label: 'Offene Reklamationen', value: String(dashboardMetrics.openComplaints), note: dashboardMetrics.overdueComplaints ? `${dashboardMetrics.overdueComplaints} ueberfaellig` : 'Keine ueberfaelligen Vorgaenge' },
    { label: 'Qualitaetsprobleme', value: String(dashboardMetrics.recentQualityIssues), note: 'Nicht bestandene Kontrollen, letzte 30 Tage' },
  ];
