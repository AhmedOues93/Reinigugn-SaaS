...
export default async function DashboardPage() {
  ...
  return <div className="mx-auto max-w-6xl">
    <div className="mb-8"><p className="text-sm font-medium text-teal-700">{company?.name}</p><h1 className="mt-1 text-2xl font-semibold tracking-tight sm:text-3xl">{t(locale, 'dashboard.welcome', { name: firstName })}</h1><p className="mt-2 text-slate-600">{t(locale, 'dashboard.subtitle')}</p></div>
