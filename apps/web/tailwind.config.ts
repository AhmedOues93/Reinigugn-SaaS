  ...
  theme: {
    extend: {
      ...
      borderRadius: {
        ...
        /* Panels sit two steps softer than the controls inside them, which is
           what stops a card of inputs reading as one undifferentiated blob. */
        card: 'calc(var(--radius) + 2px)',
      },
      boxShadow: {
        card: '0 1px 2px -1px rgb(15 31 33 / 0.08), 0 1px 3px 0 rgb(15 31 33 / 0.04)',
        raised: '0 1px 2px 0 rgb(15 31 33 / 0.05), 0 8px 24px -12px rgb(15 31 33 / 0.18)',
        popover: '0 16px 40px -12px rgb(15 31 33 / 0.28), 0 4px 12px -6px rgb(15 31 33 / 0.12)',
        glass: '0 1px 0 0 rgb(255 255 255 / 0.12) inset, 0 30px 60px -20px rgb(3 20 26 / 0.65)',
      },
      spacing: {
      ...
      keyframes: {
        ...
        loading_sweep: { '0%': { transform: 'translateX(-110%)' }, '100%': { transform: 'translateX(330%)' } },
      },
      animation: {
        ...
        'loading-sweep': 'loading_sweep 1.35s cubic-bezier(0.45, 0, 0.35, 1) infinite',
      },
    },
  },
